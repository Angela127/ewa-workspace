...
"[project]/node_modules/@rive-app/canvas/rive.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@rive-app/react-canvas/dist/index.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
var e = __turbopack_require__("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)"), t = __turbopack_require__("[project]/node_modules/@rive-app/canvas/rive.js [app-ssr] (ecmascript)");
function n(e) {
...
function h(t, n) {
    ...
    var a, u, s, c = e.useRef(new f((a = function(e) {
        d && o({
    ...
    return e.useEffect(function() {
        ...
        if (n) {
            var i = t.current;
            return t.current && d && e.observe(t.current), function() {
...
function w(t) {
    var n = t.riveLoaded, i = void 0 !== n && n, r = t.canvasElem, o = t.containerRef, a = t.options, u = void 0 === a ? {} : a, c = t.onCanvasHasResized, l = t.artboardBounds, f = b(u), d = e.useState({
        ...
        height: 0,
        width: 0
    }), m = g[0], R = m.height, C = m.width, E = g[1], O = e.useState(!0), x = O[0], T = O[1], P = f.fitCanvasToArtboardHeight, L = f.shouldResizeCanvasToContainer, S = f.useDevicePixelRatio, k = f.customDevicePixelRatio, M = h(o, L), j = s(k), z = null != l ? l : {}, H = z.maxX, I = z.maxY, D = e.useCallback(function() {
...
function O(n, o) {
    void 0 === o && (o = {});
    var a = e.useState(null), u = a[0], c = a[1], l = e.useRef(null), f = e.useState(null), d = f[0], v = f[1], h = Boolean(n), p = b(o), y = s(), g = e.useCallback(function() {
        if (d) {
    ...
    e.useEffect(function() {
        if (u && n && null == d) {
            ...
            i.on(t.EventType.Load, function() {
                u ? v(i) : i.cleanup();
            });
        }
    }, [
    ...
    var R = e.useCallback(function(e) {
        ...
        observe: e.useCallback(function(e, t) {
    ...
    e.useEffect(function() {
        ...
        return u && !1 !== p.shouldUseIntersectionObserver && x(u, function(i) {
...
//# sourceMappingURL=node_modules_5c7006._.js.map