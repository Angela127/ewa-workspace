(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_8e093a._.js", {
...
"[project]/node_modules/@rive-app/canvas/rive.js [app-client] (ecmascript)": (function(__turbopack_context__) {
                ...
                var Rive = (()=>{
                    ...
                    return function(moduleArg = {}) {
                        ...
                        var Za, $a, db = {
                            ...
                            445906: ()=>void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia,
                            446010: ()=>{
                                try {
                            ...
                            449058: (a)=>window.h.ra(a).J.sampleRate,
                            449131: (a)=>{
                                a = window.h.ra(a);
...
"[project]/node_modules/@rive-app/react-canvas/dist/index.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var e = __turbopack_require__("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)"), t = __turbopack_require__("[project]/node_modules/@rive-app/canvas/rive.js [app-client] (ecmascript)");
function n(e) {
    return e && "object" == typeof e && "default" in e ? e : {
        default: e
    };
}
var i = /*#__PURE__*/ n(e), r = function() {
...
function s(t) {
    var n = t || c(), i = e.useState(n), r = i[0], o = i[1];
    return e.useEffect({
        "s.useEffect": function() {
            if ("undefined" != typeof window && "matchMedia" in window) {
                var e = {
                    "s.useEffect.e": function() {
                        var e = t || c();
                        o(e);
                    }
                }["s.useEffect.e"], n = window.matchMedia("screen and (resolution: ".concat(r, "dppx)"));
                return n.hasOwnProperty("addEventListener") ? n.addEventListener("change", e) : n.addListener(e), ({
                    "s.useEffect": function() {
...
var f = globalThis.ResizeObserver || l, d = void 0 !== globalThis.ResizeObserver, v = !d;
function h(t, n) {
    void 0 === n && (n = !0);
    var i = e.useState({
        width: 0,
    ...
    var a, u, s, c = e.useRef(new f((a = ({
        "h.useRef[c]": function(e) {
            d && o({
    ...
    return e.useEffect({
        "h.useEffect": function() {
            ...
            if (n) {
                var i = t.current;
                return t.current && d && e.observe(t.current), ({
                    "h.useEffect": function() {
                        e.disconnect(), i && d && e.unobserve(i);
                    }
                })["h.useEffect"];
            }
            e.disconnect();
...
function w(t) {
    var n = t.riveLoaded, i = void 0 !== n && n, r = t.canvasElem, o = t.containerRef, a = t.options, u = void 0 === a ? {} : a, c = t.onCanvasHasResized, l = t.artboardBounds, f = b(u), d = e.useState({
        height: 0,
        width: 0
    }), v = d[0], p = v.height, w = v.width, y = d[1], g = e.useState({
        height: 0,
        width: 0
    }), m = g[0], R = m.height, C = m.width, E = g[1], O = e.useState(!0), x = O[0], T = O[1], P = f.fitCanvasToArtboardHeight, L = f.shouldResizeCanvasToContainer, S = f.useDevicePixelRatio, k = f.customDevicePixelRatio, M = h(o, L), j = s(k), z = null != l ? l : {}, H = z.maxX, I = z.maxY, D = e.useCallback({
        "w.useCallback[D]": function() {
            var e, t, n, i, r = null !== (t = null === (e = o.current) || void 0 === e ? void 0 : e.clientWidth) && void 0 !== t ? t : 0, a = null !== (i = null === (n = o.current) || void 0 === n ? void 0 : n.clientHeight) && void 0 !== i ? i : 0;
            return P && l ? {
                width: r,
                height: r * (l.maxY / l.maxX)
            } : {
                width: r,
                height: a
            };
    ...
    e.useEffect({
        "w.useEffect": function() {
            if (L && o.current && i) {
                var e = D(), t = e.width, n = e.height, a = !1;
                if (r) {
                    var u = t !== w || n !== p;
                    if (f.fitCanvasToArtboardHeight && u && (o.current.style.height = n + "px", a = !0), f.useDevicePixelRatio) {
                        if (u || t * j !== C || n * j !== R) {
                            var s = j * t, l = j * n;
                            r.width = s, r.height = l, r.style.width = t + "px", r.style.height = n + "px", E({
                                width: s,
                                height: l
                            }), a = !0;
                        }
                    } else u && (r.width = t, r.height = n, E({
                        width: t,
                        height: n
                    }), a = !0);
                    y({
...
var y, g = function() {
    function e() {}
    return e.prototype.observe = function() {}, e.prototype.unobserve = function() {}, e.prototype.disconnect = function() {}, e;
}(), m = globalThis.IntersectionObserver || g, R = function() {
    function e() {
        var e = this;
...
function E(e) {
    var t = e.setContainerRef, n = e.setCanvasRef, a = e.className, u = void 0 === a ? "" : a, s = e.style, c = e.children, l = o(e, [
        "setContainerRef",
        "setCanvasRef",
        "className",
        "style",
    ...
    return i.default.createElement("div", r({
        ...
        style: f
    }), i.default.createElement("canvas", r({
        ref: n,
        style: {
            verticalAlign: "top",
            width: 0,
...
function O(n, o) {
    void 0 === o && (o = {});
    var a = e.useState(null), u = a[0], c = a[1], l = e.useRef(null), f = e.useState(null), d = f[0], v = f[1], h = Boolean(n), p = b(o), y = s(), g = e.useCallback({
        "O.useCallback[g]": function() {
            if (d) {
                if (d.layout && d.layout.fit === t.Fit.Layout && u) {
                    var e = y * d.layout.layoutScaleFactor;
                    d.devicePixelRatioUsed = y, d.artboardWidth = (null == u ? void 0 : u.width) / e, d.artboardHeight = (null == u ? void 0 : u.height) / e;
                }
    ...
    e.useEffect({
        "O.useEffect": function() {
            if (u && n && null == d) {
                var e = p.useOffscreenRenderer, i = new t.Rive(r(r({
                    useOffscreenRenderer: e
                }, n), {
                    canvas: u
                }));
                i.on(t.EventType.Load, {
                    "O.useEffect": function() {
                        u ? v(i) : i.cleanup();
                    }
                }["O.useEffect"]);
    ...
    var R = e.useCallback({
        "O.useCallback[R]": function(e) {
            l.current = e;
        }
    }["O.useCallback[R]"], []), O = {
        observe: e.useCallback({
            "O.useCallback": function(e, t) {
                C().registerCallback(e, t);
            }
        }["O.useCallback"], []),
        unobserve: e.useCallback({
            "O.useCallback": function(e) {
                C().removeCallback(e);
            }
        }["O.useCallback"], [])
    }, x = O.observe, T = O.unobserve;
    e.useEffect({
        "O.useEffect": function() {
            var e, t = !1, n = {
                "O.useEffect.n": function() {
                    if (u && t) {
                        var e = u.getBoundingClientRect();
                        e.width > 0 && e.height > 0 && e.top < (window.innerHeight || document.documentElement.clientHeight) && e.bottom > 0 && e.left < (window.innerWidth || document.documentElement.clientWidth) && e.right > 0 && (null == d || d.startRendering(), t = !1);
                    }
                }
            }["O.useEffect.n"];
            return u && !1 !== p.shouldUseIntersectionObserver && x(u, {
                "O.useEffect": function(i) {
                    i.isIntersecting ? d && d.startRendering() : d && d.stopRendering(), t = !i.isIntersecting, clearTimeout(e), i.isIntersecting || 0 !== i.boundingClientRect.width || (e = setTimeout(n, 10));
                }
            }["O.useEffect"]), ({
                "O.useEffect": function() {
                    u && T(u);
        ...
        d,
        u,
        p.shouldUseIntersectionObserver
    ]), e.useEffect({
        "O.useEffect": function() {
            return ({
                "O.useEffect": function() {
    ...
    var P = null == n ? void 0 : n.animations;
    e.useEffect({
        "O.useEffect": function() {
            d && P && (d.isPlaying ? (d.stop(d.animationNames), d.play(P)) : d.isPaused && (d.stop(d.animationNames), d.pause(P)));
        }
    }["O.useEffect"], [
        P,
        d
...
exports.default = function(e) {
    var t = e.src, n = e.artboard, a = e.animations, u = e.stateMachines, s = e.layout, c = e.useOffscreenRenderer, l = void 0 === c || c, f = e.shouldDisableRiveListeners, d = void 0 !== f && f, v = e.shouldResizeCanvasToContainer, h = void 0 === v || v, p = e.automaticallyHandleEvents, b = void 0 !== p && p, w = e.children, y = o(e, [
        "src",
        "artboard",
        "animations",
        "stateMachines",
        ...
        useOffscreenRenderer: l,
        shouldResizeCanvasToContainer: h
    }).RiveComponent;
    return i.default.createElement(g, r({}, y), w);
}, exports.useResizeCanvas = w, exports.useRive = O, exports.useRiveFile = function(n) {
    var i = this, r = e.useState(null), o = r[0], s = r[1], c = e.useState("idle"), l = c[0], f = c[1];
    return e.useEffect(function() {
        var e = null;
        return a(i, void 0, void 0, function() {
            return u(this, function(i) {
                try {
                    f("loading"), (e = new t.RiveFile(n)).init(), e.on(t.EventType.Load, function() {
                        null == e || e.getInstance(), s(e), f("success");
                    }), e.on(t.EventType.LoadError, function() {
                        f("failed");
                    }), s(e);
                } catch (e) {
...
}, exports.useStateMachineInput = function(n, i, r, o) {
    var a = e.useState(null), u = a[0], s = a[1];
    return e.useEffect(function() {
        function e() {
            if (n && i && r || s(null), n && i && r) {
                var e = n.stateMachineInputs(i);
                if (e) {
                    var t = e.find(function(e) {
                        return e.name === r;
                    });
                    void 0 !== o && t && (t.value = o), s(t || null);
                }
            } else s(null);
        }
        e(), n && n.on(t.EventType.Load, function() {
            e();
        });
    }, [
        n
...
//# sourceMappingURL=node_modules_8e093a._.js.map